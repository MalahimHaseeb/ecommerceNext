  ...
  return (
    <div className='min-h-screen'>
      <Head>
        ...
        <meta name='description' content='Mugs - Wear the code' />
        <link rel="icon" href="/favicon.io" />
      </Head>
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto ">
          <div className="flex flex-wrap -m-4">
          {Object.keys(products).length === 0 && <p >Sorry ! All Mugs are out of stock.New stock will coming soon.</p>}
          {Object.keys(products).map((item)=>{  
            ...
            return  <div key={products[item]._id} className="lg:w-1/5 md:w-1/2 p-2 w-full shadow-lg m-5">
              ...
              <div className="mt-4 text-center">
                ...
                {products[item].color.includes('pink') && <button className="border-2 border-gray-300 ml-1 bg-pink-700 rounded-full w-4 h-4 focus:outline-none" />}
                ...
                {/* {products[item].color.includes('pink') && <button className="border-2 border-gray-300 ml-1 bg-orange-500 rounded-full w-6 h-6 focus:outline-none" />} */}
